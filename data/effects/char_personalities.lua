...
char_personalities = {
  ...
  p_bold = {
    name = "p_bold",
    desc_short = "Bold",
    desc_long = "Lay on, Macduff, and damned be him who first cries 'Hold! Enough!",
    VIG = {'actor','addsub',1},
    LIB = {'actor','addsub',1},
    reputation = {'actor','*',1.1},
    morale = {'actor','addsub',5},
  ...
  p_idealistic = {
    ...
    desc_long = "In attaining our ideals, our means should be as pure as the end.",
    LIB = {'actor','addsub',1},
    TEN = {'actor','addsub',1},
    reputation = {'actor','*',1.1},
    morale = {'actor','addsub',5},
  ...
  p_pragmatic = {
    ...
    desc_long = "What matters is what works.",
    LIB = {'actor','addsub',1},
    INT = {'actor','addsub',1},
    reputation = {'actor','*',0.9},
    morale = {'actor','addsub',-5},
  ...
  p_diligent = {
    name = "p_diligent",
    desc_short = "Diligent",
    desc_long = "The reward of a work is to have produced it; the reward of effort is to have grown by it.",
    VIG = {'actor','addsub',1},
    TEN = {'actor','addsub',1},
    ACU = {'actor','addsub',1},
    SPD = {'actor','addsub',1},
