...
list = {
  ...
  p_ideachar_personalitiesic = {
    desc_short = "Ideachar_personalitiesic",
    desc_long = "PLACEHOLDER",
    LIB = 1,
    TEN = 1,
    reputation_multiply = 0.1,
  ...
  p_pragmatic = {
    ...
    INT = 1,
    reputation_multiply = -0.1,
    overwrites = {p_ideachar_personalitiesic}
    -- They have no relation to each other, and tend to minorly dislike their opposite, Cautious characters.
  },
...
-- apply p_base (todo: make this inherit instead)
--[[
for k,v in pairs(char_personalities) do
  table.merge(char_personalities[k],p_base)
end
--]]
