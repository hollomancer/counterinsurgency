...
local function test()
  char_test = Char.Generate(300,300)

  for k,v in pairs(char_test) do print(k,v) end
  print(char_test.base_INT+char_test.base_VIG+char_test.base_LIB+char_test.base_TEN+char_test.base_ACU+char_test.base_SPD)
end